                   ...
                   int length)
{
    while( length > 0 )
    {
        sm4_one_round( key->sk, input, output );
...
/*
 * SM4-CBC buffer encryption
 * length must be power of 16 byte
 */
                     ...
                     int length )
{
    ...
    while( length > 0 )
    {
        ...
        sm4_one_round( key->sk, output, output );
